...
class Application:
    ...
    def search_db(self):
        ...
        for self.row in self.res:
            ...
            self.docname = self.row[4]
            self.docsp = self.row[5]
        ...
        self.udocname = Label(self.master, text="Doctor's Name", font=('arial 18 bold'))
        self.udocname.place(x=0, y=300)

        self.udocsp = Label(self.master, text="Doctor's Specialization", font=('arial 18 bold'))
        self.udocsp.place(x=0, y=340)
        ...
        self.ent5.insert(END, str(self.docname))

        self.ent6 = Entry(self.master, width=30)
        self.ent6.place(x=300, y=340)
        self.ent6.insert(END, str(self.docsp))
    ...
    def update_db(self):
        ...
        self.var5 = self.ent5.get() #updated doctor's name
        self.var6 = self.ent6.get() #updated doctor's specialization
        self.var7 = self.ent7.get() #updated time
        
        query = "UPDATE appointments SET name=?, age=?, gender=?, phone=?, docname=?, docsp=?, time=? WHERE name LIKE ?"
